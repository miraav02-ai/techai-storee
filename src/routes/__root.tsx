  ...
  head: () => ({
    meta: [
      ...
      { title: "LaptopAI Store — Intelligent Laptop Shopping Experience powered by AI" },
      {
        name: "description",
        content:
          "Intelligent Laptop Shopping Experience powered by AI. Explore 70 laptops across ASUS, Lenovo, Acer, HP, Dell, MSI, and Apple with spec-level matching.",
      },
      ...
      { property: "og:title", content: "LaptopAI Store — Intelligent Laptop Shopping Experience powered by AI" },
      {
        ...
        content:
          "Intelligent Laptop Shopping Experience powered by AI across 7 top brands and 70 models.",
      },
